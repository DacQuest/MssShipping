...
namespace Mss.Views
{
    public partial class AdminSlugView : XSharedArrayProxyEditorView<LoadItem>
    {
        public AdminSlugView()
        {
            InitializeComponent();
        }
        ...
        {
            LoadItem loadItem = GetDataItemCopy(index);
            return loadItem.Coordinates;
        }
