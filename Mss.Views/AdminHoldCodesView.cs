...
namespace Mss.Views
{
    public partial class AdminHoldCodesView : XSharedDictionaryProxyEditorView<int, HoldCodeItem>
    {
        public AdminHoldCodesView()
        {
            InitializeComponent();
        }
        ...
        {
            return key == null ? string.Empty : $"Hold Code {key:0000000})";
        }
